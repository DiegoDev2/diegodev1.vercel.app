    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        width: visible ? "50%" : "70%",
        paddingInline: visible ? "1.5rem" : "2rem",
        y: visible ? 20 : 0,
      }}
      transition={{
        type: "spring",
      ...
      className={cn(
        "relative z-[60] mx-auto hidden max-w-7xl flex-row items-center justify-between self-start rounded-full bg-transparent py-2 lg:flex dark:bg-transparent",
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <span className="font-medium text-xl text-white">DiegoDev1</span>
    </a>
  );
};
