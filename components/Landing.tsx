  ...
  return (
    ...
    >
      <div className="relative text-center z-10 flex flex-col items-center gap-4 sm:gap-6 mt-8">
        <button
          className={`relative flex items-center px-4 py-2 text-sm font-light text-white bg-neutral-900 shadow-inner shadow-neutral-700 hover:shadow-neutral-600 rounded-xl transition w-auto ${geist.className}`}
        >
        ...
        <p className="text-xs font-extralight sm:text-base md:text-lg text-gray-300">
          Specialized in DevOps workflows, cutting-edge front-end development,{" "}
          <br />
          and custom CLI tools for efficient, high-performance projects.
        </p>
      </div>

      <div ref={imageContainer} className="w-full will-change-transform">
        <Image
          src="/ui/hands.webp"
          width={800}
          height={800}
